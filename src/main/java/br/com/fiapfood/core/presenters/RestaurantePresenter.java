...
public class RestaurantePresenter {
	...
	public static DadosRestauranteDto toRestauranteDto(RestauranteEntity restaurante) {
		return new DadosRestauranteDto(restaurante.getId(), restaurante.getNome(), restaurante.getEndereco().getId(), restaurante.getDono().getId(), 
	...
	public static DadosRestauranteDto toRestauranteDto(Restaurante restaurante) {
		return new DadosRestauranteDto(restaurante.getId(), restaurante.getNome(), restaurante.getIdEndereco(), restaurante.getIdDonoRestaurante(), 
									   restaurante.getIdTipoCulinaria(), restaurante.getIsAtivo(), AtendimentoPresenter.toListAtendimentoDto(restaurante.getAtendimentos()));
	}
	...
	public static Restaurante toRestaurante(CadastrarRestauranteCoreDto restaurante) {
		return Restaurante.criar(null, restaurante.nome(), null, restaurante.idDonoRestaurante(), 
								 restaurante.idTipoCulinaria(), true, AtendimentoPresenter.toListAtendimento(restaurante.atendimentos()));
	}

	public static Restaurante toRestaurante(DadosRestauranteDto restaurante) {
		return Restaurante.criar(restaurante.id(), restaurante.nome(), restaurante.idEndereco(), restaurante.idDono(), 
								 restaurante.idTipoCulinaria(), restaurante.isAtivo(), AtendimentoPresenter.toListAtendimento(restaurante.atendimentos()));
	}
	
	public static RestauranteEntity toRestauranteEntity(DadosRestauranteDto restaurante, EnderecoCoreDto endereco, List<AtendimentoCoreDto> atendimentos) {
		return new RestauranteEntity(restaurante.id(), 
									 restaurante.nome(), 
									 EnderecoPresenter.toEnderecoEntity(endereco), 
									 ...
									 restaurante.isAtivo(), 
									 null,
									 AtendimentoPresenter.toListAtendimentoEntity(atendimentos));
	}
		
	public static RestauranteEntity toRestauranteEntity(DadosRestauranteDto restaurante) {
		return new RestauranteEntity(restaurante.id(), 
									 restaurante.nome(), 
									 EnderecoPresenter.toEnderecoResumidoEntity(restaurante.idEndereco()), 
									 UsuarioPresenter.toUsuarioResumidoEntity(restaurante.idDono()), 
									 TipoCulinariaPresenter.toTipoCulinariaResumidoEntity(restaurante.idTipoCulinaria()),
									 restaurante.isAtivo(), 
									 null,
									 AtendimentoPresenter.toListAtendimentoResumidoEntity(restaurante.atendimentos()));
	}
	
	public static RestauranteEntity toRestauranteComAtendimentosEntity(DadosRestauranteDto restaurante) {
		return new RestauranteEntity(restaurante.id(), 
									 restaurante.nome(), 
									 EnderecoPresenter.toEnderecoResumidoEntity(restaurante.idEndereco()), 
									 UsuarioPresenter.toUsuarioResumidoEntity(restaurante.idDono()), 
